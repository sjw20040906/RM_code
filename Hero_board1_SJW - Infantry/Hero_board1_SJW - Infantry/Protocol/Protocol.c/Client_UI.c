...
void UI_PushUp_Graphs(uint8_t cnt, void *Graphs)
{
   ...
   if(cnt == 1) HAL_UART_Transmit_DMA(UART_Instance[2].huart, (uint8_t *)Graph, sizeof(UI_Graph1_t));
	else if(cnt == 2) HAL_UART_Transmit_DMA(UART_Instance[2].huart, (uint8_t *)Graph, sizeof(UI_Graph2_t));
	else if(cnt == 5) HAL_UART_Transmit_DMA(UART_Instance[2].huart, (uint8_t *)Graph, sizeof(UI_Graph5_t));
	else if(cnt == 7) HAL_UART_Transmit_DMA(UART_Instance[2].huart, (uint8_t *)Graph, sizeof(UI_Graph7_t));
...
{  
   ...
   HAL_UART_Transmit_DMA(UART_Instance[2].huart, (uint8_t *)String, sizeof(UI_String_t));
...
{   
   ...
   HAL_UART_Transmit_DMA(UART_Instance[2].huart, (uint8_t *)Delete, sizeof(UI_Delete_t));
