...
void Robot_Control(void const *argument)
{
    ...
    for (;;)
    {
        ...
        J4310_Fun.J4310_setParameter(J4310s_Pitch.outPosition, J4310s_Pitch.outSpeed, J4310s_Pitch.outKp, J4310s_Pitch.outKd, J4310s_Pitch.outTorque, data3);
        /****************发送电流数据***************/
        ...
        Can_Fun.CAN_SendData(CAN_SendHandle, &hcan2, CAN_ID_STD, J4310_SENDID_Pitch, data3);
        /****************发送电流数据 end***************/
