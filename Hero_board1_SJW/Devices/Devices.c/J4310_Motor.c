...
void J4310_Enable()
{
  ...
  // Can_Send_Data.CAN_TxHeader.ErrorStateIndicator =  CAN_ESI_ACTIVE;  //发送节点处于主动错误状态
  // Can_Send_Data.CAN_TxHeader.BitRateSwitch = CAN_BRS_OFF;        //不转换波特率
  // Can_Send_Data.CAN_TxHeader.FDFormat =  CAN_CLASSIC_CAN;        //经典CAN模式
